...
class DealsPageWidget extends StatefulWidget {
  const DealsPageWidget({Key? key}) : super(key: key);

  @override
  _DealsPageWidgetState createState() => _DealsPageWidgetState();
}

class _DealsPageWidgetState extends State<DealsPageWidget> {
  @override
  void initState() {
    super.initState();
  }
